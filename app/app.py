...
from app.schemas.schema import PostGet
from app.database.models.post import Post
from app.database.models.user import User
from app.database.models.feed import Feed
from app.ml.load_models import load_model
from app.services.load_features import load_features
...
posts, users = pd.read_csv("../data/post_feature_to_SQL_new", sep=";"),pd.read_csv("../data/user_feature_to_SQL_new", sep=";")
